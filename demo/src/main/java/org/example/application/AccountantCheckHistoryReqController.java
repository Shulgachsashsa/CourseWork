...
public class AccountantCheckHistoryReqController {
    ...
    private void loadRequestHistory() {
        ...
        Request request = new Request(CommandType.GET_REQUEST_BY_ID_PROCESS, userId);
        try {
    ...
    private void handleFilter() {
        ChoiceDialog<String> dialog = new ChoiceDialog<>("Все", "Одобрено", "Отклонено");
